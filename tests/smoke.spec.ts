...
const ROUTES = [
  ...
  { path: "/tools/migration-readiness/", title: /Migration readiness check/ },
  { path: "/tools/no-show-calculator/", title: /No-show revenue calculator/ },
  { path: "/tools/compare-pms/", title: /PMS comparison picker/ },
  { path: "/tools/day-in-the-life/", title: /Day in the life/ },
